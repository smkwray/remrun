...
def test_profile_project_id_collapses_only_known_nested_worktree_roots():
    assert profile_project_id("sample-project/.worktrees/v1-builder") == "sample-project"
    assert profile_project_id("sample-project/.claude/worktrees/agent-a") == "sample-project"
    assert profile_project_id("sample-project/.delegate-worktrees/a") == "sample-project"
    assert profile_project_id("group/sample-project") == "group/sample-project"
